...
<div class="input-group mb-3">
  ...
  <input type="number" class="form-control" placeholder="#" name="cantidad" id="cantidad" value="<?php echo $cantidad;?>" readonly>
</div>
<div class="input-group mb-3">
  <span class="input-group-text"><b>Precio</b></span>
  <input type="text" class="form-control" placeholder="00.00" name="precio" id="precio" value="<?php echo $precio;?>" readonly>
</div>