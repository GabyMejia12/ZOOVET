...
<div class="modal" id="ModalPrincipal5" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div  id="DataEfectosModal5" class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel"><label id="DataTituloModal5"></label></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body" id="DataModalPrincipal5">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
        <button type="button" id="ProcesoBotonModal" class="btn btn-primary"><label id="TituloBotonModal"></label></button>
        <button type="button" id="ProcesoBotonModal5" class="btn btn-primary"><label id="TituloBotonModal5"></label></button>
      </div>
    </div>
  </div>
</div>
