...
<form id="filterForm" class="form-inline mb-3">
            ...
            <input type="date" name="fecha_inicio" id="fecha_inicio" class="form-control mr-4">

            <label for="fecha_fin" class="mr-2">Fecha de fin:</label>
            <input type="date" name="fecha_fin" id="fecha_fin" class="form-control mr-4">
            ...
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-4 p-0 flex justify-content-lg-start justify-content-center">
                        <h2 class="ml-lg-2">Controles Profilácticos</h2>
                    </div>
...
<div class="table-responsive" id="DataPanelProfilactico">
...
<script>
    $(document).ready(function() {
        $("#panel-entradas").click(function() {
            $("#sub-data").load("./views/consultas/profilactico/nueva_consulta.php");
            return false;
        });
    });
    ...
    $('#filterForm').submit(function(event) {
        ...
        $.ajax({
            type: 'GET',
            url: './views/consultas/profilactico/getConsultas.php',
            data: { fecha_inicio: fechaInicio, fecha_fin: fechaFin },
            success: function(response) {
                $('#DataPanelProfilactico').html(response); // Actualiza la tabla con los datos recibidos
            },
...
$(document).ready(function () {
    $("#searchButton").click(function () {
        ...
        const activePanelId = "DataPanelProfilactico"; // Especificamos que estamos en el panel de Mascotas

        if (query) {
            $.ajax({
                url: './views/consultas/profilactico/busqueda.php',
                method: 'POST',
                data: {
                    query: query,
                    panel: activePanelId
